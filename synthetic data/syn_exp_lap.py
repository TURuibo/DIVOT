...
def main():
	...
	for seed in range(num_exp):
		...
		y_samples += 1.0*random.laplace(knoise,shape=(nsamples, 1))
		...
		c_loss_res, c_t_res, c_gradt_res, params_c = test(c_batches, key, step_sz = 0.05,exp = 100,nrep = 50)
		...
		rv_loss_res,rv_t_res,rv_gradt_res,params_rv = test(rv_batches, key, step_sz = 0.05,exp = 100,nrep = 50)
